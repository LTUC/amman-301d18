...
// this refers to the object that called it, and in this case, it's Joe
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" refers to the global scope when used for a prototype, that is the Window itself
// 3. Explain why "this" is different when an arrow function is used.
// the difference between them is the scope, one is local (for the object that called it), and the other is 
// global (refers to the Window, that is the whole html tag with everything), i can't exaplin it further more. 
