...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT because the we call the variable out of its scope; A variable declared with the const keyword is limited to the block-scoped only.
  console.log(viewed);
