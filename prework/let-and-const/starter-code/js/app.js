...
function displayPics(){
  ...
  // the problem happend exactly in 'line 33 ' when we change it from 'var' to 'let' , 
  //let  work in code block which is 'while' block , var is more general work in function block ( function-scoped) 
  console.log(viewed);
