...
function displayPics(){
  ...
  /* Because var is globaly and it's declared before in other function but when we changes it to let , an error appears
  that told us that the variable is not declared because let is  localy and the variable not declared in the same place . */
  console.log(viewed);
